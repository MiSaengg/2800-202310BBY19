...
export default function SubmitMainThread() {
  ...
  const handleAIGenerate = async () => {
    ...
    const generatedText = "This is generated by AI";  // Replace this line with your AI text generation logic
      ...
      <div className='flex px-4 py-4'>
        <form onSubmit={handleMainThreadSubmit} className="w-full">
          ...
          <div className="absolute right-3 px-3">
            ...
            <Button text="AI Generate" onClick={handleAIGenerate} type="button" />
